"""
Django settings for culinaryguidance_ap_45455 project.
...
ROOT_URLCONF = 'culinaryguidance_ap_45455.urls'
...
WSGI_APPLICATION = 'culinaryguidance_ap_45455.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "culinaryguidance_ap_45455 API",
    "DESCRIPTION": "API documentation for culinaryguidance_ap_45455 App",
    "VERSION": "v1",
}
